 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_md')){
	function azrcrv_create_plugin_menu_md(){
		azrcrv_create_plugin_menu_table_md();
		azrcrv_populate_plugin_menu_table_md();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_md')){
	function azrcrv_populate_plugin_menu_table_md(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_md')){
	function azrcrv_create_plugin_menu_table_md(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
